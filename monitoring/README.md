...
This stack is an independent local playground for Prometheus and Grafana. It does not require Ignite, does not join `ignite-lab`, and can run alongside the Ignite `ops/` stack.
